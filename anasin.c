...
static NodoArbol *seleccion_sentencia( void )
{
    ...
    return temporal;
} /* fin de funcion seleccion_sentencia */

static NodoArbol *sentencia_seleccionar(NodoListaLexema *lista)
{
    ...
    temporal->hijo[0] = nuevoNodoExpresion(TIPOARBOL_CONSTANTE);
...
static NodoArbol *iteraccion_sentencia( void )
{
    ...
    return temporal;
} /* fin de la funcion iteraccion_sentencia */
