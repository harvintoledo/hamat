...
#include "../../Principal/Occam/classwizard.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_CodeStylePage_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
const QMetaObject CodeStylePage::staticMetaObject = {
    { &QWizardPage::staticMetaObject, qt_meta_stringdata_CodeStylePage.data,
      qt_meta_data_CodeStylePage,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CodeStylePage.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_OutputFilesPage_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
const QMetaObject OutputFilesPage::staticMetaObject = {
    { &QWizardPage::staticMetaObject, qt_meta_stringdata_OutputFilesPage.data,
      qt_meta_data_OutputFilesPage,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_OutputFilesPage.stringdata))
